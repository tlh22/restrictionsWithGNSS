SELECT "Area", "GeometryID", "RoadName", "Location", "RestrictionLength", "NrBays", "Notes", "LastUpdateDateTime", "LastUpdatePerson", "MHTC_CheckIssueTypeID", "MHTC_CheckNotes", "Photos_01", name, sections, bay_type, baylist_type, "TimePeriod_Description", "MaxStay_Description", "TheoreticalSpaces", "Capacity", baylist_notes_1, baylist_notes_2,
