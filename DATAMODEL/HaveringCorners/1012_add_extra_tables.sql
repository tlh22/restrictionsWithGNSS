...
(
    ...
    CONSTRAINT "HaveringMapFrames_HaveringMapFramesAllowableScales_fkey" FOREIGN KEY ("map_scale")
        REFERENCES havering_operations."HaveringMapFramesAllowableScales" ("Code")
    CONSTRAINT "HaveringMapFrames_HaveringMapFramesCategoryTypeID_fkey" FOREIGN KEY ("JunctionProtectionCategoryTypeID")
...
(
    ...
    CONSTRAINT "JunctionsWithinMapFrames_MapFrameID_key" UNIQUE ("MapFrameID"),
...
-- Need mechanism to change frame geom when scale is changed
??
